                        ...
                        <table class="table m-0">
                            ...
                            <tbody>
                                @foreach($signals as $signal)
                                    <tr>
                                        <td class="py-4">{{ $signal->created_at->format('m/d/Y') }} <span
                                                class="ms-1">{{ $signal->created_at->format('g:i:s A') }}</span></td>
                                        <td class="pe-4 py-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/images/' . strtolower(str_replace('/', '-', $signal->pair_name)) . '.jpeg') }}"
                                                    class="me-2" style="width: 30px; height: 30px;"
                                                    alt="{{ $signal->pair_name }}">
                                        ...
                                        <td
                                            class="py-4 {{ $signal->is_open ? 'text-warning' : ($signal->take_profit ? 'text-success' : 'text-danger') }}">
