                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    ...
                                                    <span class="d-block fs-12 text-fixed-white"><span class="op-7">You have
                                                            ...
                                                            class="op-7">of the given target, you can also check your
                                                            status</span>.</span>
                                        ...
                                        <ul class="list-unstyled crm-top-deals mb-0">
                                                ...
                                                <div class="d-flex align-items-top flex-wrap">
                                                    <div class="me-2">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            ...
                                                            <img src="{{asset('images/faces/10.jpg')}}" alt="">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-top flex-wrap">
                                                    <div class="me-2">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{asset('images/faces/12.jpg')}}" alt="">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-semibold">
                                                            <span class="avatar avatar-sm me-2 avatar-rounded">
                                                                <img src="{{asset('images/faces/15.jpg')}}" alt="img">
                                                            ...
                                                            <div class="crm-timeline-content">
                                                                <span class="fw-semibold">Update of calendar events
                                                                    &amp;</span><span><a href="javascript:void(0);"
                                                                        class="text-primary fw-semibold"> Added new events
                                                                        in next week.</a></span>
                                                            </div>
                                                    ...
                                                    <li class="crm-recent-activity-content">
                                                        <div class="d-flex align-items-top">
                                                            ...
                                                            <div class="crm-timeline-content">
                                                                ...
                                                                <span class="d-block fs-12 text-muted">Lorem ipsum, dolor
                                                                    sit amet.</span>
                                                            </div>
                                                            <div class="flex-fill text-end">
                                                        ...
                                                        <div class="d-flex align-items-top">
                                                            ...
                                                            <div class="crm-timeline-content">
                                                                <span>Neon Tarly added <span
                                                                        class="text-info fw-semibold">Robert Bright</span>
