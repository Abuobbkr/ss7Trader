                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Security<span
                                class="badge bg-success-transparent ms-2">4</span></span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                        ...
                        <li class="slide">
                            <a href="{{ route('signals.index') }}" class="side-menu__item">Signals</a>
                        </li>
                        <li class="slide">
                            <a href="{{ route('subscribers.index') }}" class="side-menu__item">Subscribers</a>
                        </li>
                       
                        <li class="slide">
                            <a href="data-tables.html" class="side-menu__item">User</a>
                        </li>
                        <li class="slide">
                            <a href="data-tables.html" class="side-menu__item">User Role</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
